...
import DAL.frmBoPhan;
import DAL.frmQLNhanSu;
import DAL.frmQLPhongBan;
import DAL.frmThongTinCaNhan;
...
//        });
        ...
        if (k == 0) {
            MenuItem menuDanhMuc = new MenuItem(iconDanhMuc, "Danh Mục", null, menuNhanSu, menuTTCN);
            MenuItem menuQuanLy = new MenuItem(iconQuanLy, "Quản Lý", null, menuPhongBan, menuBoPhan);
            
            menuDanhMuc.setBackground(Color.black);
            menuQuanLy.setBackground(Color.black);
     
            addMenu(menuDanhMuc, menuQuanLy);
        }
        else if (k == 1) {
            MenuItem menuDanhMuc = new MenuItem(iconDanhMuc, "Danh Mục", null, menuNhanSu, menuTTCN);
            MenuItem menuQuanLy = new MenuItem(iconQuanLy, "Quản Lý", null, menuPhongBan, menuBoPhan);
