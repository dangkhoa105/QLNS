 ...
 * @author Ngoc
 */
public class frmQLPhongBan extends javax.swing.JFrame {
    ...
    public frmQLPhongBan() {
        ...
        txtNgayThanhLap.setText(" " + dateFormat.format(date));
    ...
    private void initComponents() {
        ...
        txtNgayThanhLap.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(3, 100, 117)));
        txtNgayThanhLap.setMinimumSize(new java.awt.Dimension(3, 26));
        txtNgayThanhLap.setPreferredSize(new java.awt.Dimension(3, 26));
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(cbxMaBoPhan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(lblMaBoPhan)))
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            ps.setString(4, txtNgayThanhLap.getText());
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        ...
        txtNgayThanhLap.setText(model.getValueAt(i, 3).toString());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        try {
            ...
            ps.setString(3, txtNgayThanhLap.getText());
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        try {
            ...
            int row = jTable2.getSelectedRow();
            String value = (jTable2.getModel().getValueAt(row, 1).toString());
            String sql = "DELETE FROM TblPhongBan SET WHERE MaPhong=?";
            PreparedStatement ps = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        //<editor-fold defaultstate="collapsed" desc=" Look and feel sepbing code (optional) ">
        /* If Nimbus (introduced in Java SE 6) is not available, stay with the default look and feel.
         * For details see hpbp://download.oracle.com/javase/tutorial/uiswing/lookandfeel/plaf.html 
         */
        try {
            ...
            java.util.logging.Logger.getLogger(frmQLPhongBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmQLPhongBan().setVisible(true);
            }
        });
    }
